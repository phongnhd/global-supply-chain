...
export function SiteHeader() {
  return (
    <header className="border-b border-teal-500/10 bg-background/70 backdrop-blur-xl shadow-[0_0_30px_rgba(45,212,191,0.05)]">
      ...
      <div className="flex w-full items-center px-4 md:px-8 py-4">

        <Link href="/" className="flex items-center gap-2 shrink-0">
          <img src="/icon.png" className="h-14 w-auto" />
        ...
        <div className="ml-auto flex items-center gap-3 shrink-0">
          ...
          <Link
            href="/login"
            className="rounded-md bg-[#298dff] px-4 py-1 text-sm font-semibold text-white hover:shadow-[0_0_8px_rgba(41,141,255,0.25)]"
          >
            Login
          </Link>
